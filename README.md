...
* Implements writing of protobuf messages to JSON,
* Implements reading (unboxing) of JSON into protobuf messages, with support for safe type conversions like int to double and string with decimal value - to int,
...
Be sure to check out the external submodules
