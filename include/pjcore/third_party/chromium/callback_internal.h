...
#ifndef PJCORE_THIRD_PARTY_CHROMIUM_CALLBACK_INTERNAL_H_
#define PJCORE_THIRD_PARTY_CHROMIUM_CALLBACK_INTERNAL_H_
...
#endif  // PJCORE_THIRD_PARTY_CHROMIUM_CALLBACK_INTERNAL_H_
