...
#ifndef PJCORE_THIRD_PARTY_CHROMIUM_TEMPLATE_UTIL_H_
#define PJCORE_THIRD_PARTY_CHROMIUM_TEMPLATE_UTIL_H_
...
#endif  // PJCORE_THIRD_PARTY_CHROMIUM_TEMPLATE_UTIL_H_
