...
#ifndef PJCORE_THIRD_PARTY_CHROMIUM_STRINGS_STRING_PIECE_H_
#define PJCORE_THIRD_PARTY_CHROMIUM_STRINGS_STRING_PIECE_H_
...
#include "pjcore/third_party/chromium/base_export.h"
#include "pjcore/third_party/chromium/hash_tables.h"
...
namespace PJCORE_HASH_NAMESPACE {
#if defined(COMPILER_GCC)

template<>
struct hash<pjcore::StringPiece> {
  std::size_t operator()(const pjcore::StringPiece& sp) const {
    HASH_STRING_PIECE(pjcore::StringPiece, sp);
  }
};

#elif defined(COMPILER_MSVC)

inline size_t hash_value(const pjcore::StringPiece& sp) {
  HASH_STRING_PIECE(pjcore::StringPiece, sp);
}
...
#endif  // PJCORE_THIRD_PARTY_CHROMIUM_STRINGS_STRING_PIECE_H_
