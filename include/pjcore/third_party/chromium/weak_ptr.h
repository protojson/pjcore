...
#ifndef PJCORE_THIRD_PARTY_CHROMIUM_MEMORY_WEAK_PTR_H_
#define PJCORE_THIRD_PARTY_CHROMIUM_MEMORY_WEAK_PTR_H_
...
#endif  // PJCORE_THIRD_PARTY_CHROMIUM_MEMORY_WEAK_PTR_H_
